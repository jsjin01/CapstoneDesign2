...
public class SplitMultiMonster : MonoBehaviourPun, IPunObservable
{
    ...
    protected virtual void ToDestoy() //삭제하는 함수 
    {
        ...
        PhotonNetwork.Instantiate("miniMonster", transform.position + right, rotation);
        PhotonNetwork.Instantiate("miniMonster", transform.position + left, rotation);
